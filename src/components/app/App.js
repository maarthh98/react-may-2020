...
// do 0) тут мы делаем импорт дропдауна (уже сделан)
...
// done 1) вот наши опции сортировки, мы будем их использовать в DropDown (уже объявлены)
const sortingOptions = ['Sort By Default', 'Sort By Author'];

class App extends Component {
  state = {
    posts: [...postsList],
    // done: 2) добавить под ключом selectedOption значение sortingOptions[0] (она будет хранить выбранную в данный моменит опцию)
  ...
  render() {
    // done 4) достать также в строке 92 из стейта selectedOption
    const { posts, selectOption} = this.state;
      ...
      <div className="App">
        ...
        <PanelFromLecture label="Posts">
          <div className="d-flex">
            ...
            {/* done: тут используется дропдаун
